...
=DRAW.ELLIPSE(UnqiueId, Container, Name, X, Y, Width, Height,
...
|--------------------------------------------------------------|--------|-----------------------------------------------------------------------|
| =DRAW.ELLIPSE("ID1", "", "Ellipse1", 1000, 1000, 2000, 3000) | TRUE   | Draw an ellipse, having a size of 2 by 3 cm at the position 1cm, 1cm. |
