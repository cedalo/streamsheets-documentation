...
The binary number or a \#NUM! error if given number is not a valid octal
...
|----------------|--------|----------------------------------------------|
| =OCT2BIN(3)    | 11     | converts octal 3 to binary                   |
| =OCT2BIN(3, 4) | 0011   | converts octal 3 to binary with 4 characters |
