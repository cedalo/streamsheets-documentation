...
Pauses sheet calculation until at least one of specified requests resolves. Please refer to :ref:`AWAIT <await>` too.
...
.. list-table::
   ...
   * - AWAIT.ONE(A1, B2:C3)
     - Waits for request in A1 and or one of the requests in spcefied range to resolve
