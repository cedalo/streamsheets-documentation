...
The value of specified table cell or an :ref:`error <error>` value if cell range does not contain specified cell.
...
.. list-table::
   ...
   * - =TABLE.GET(A3:D5, 93370, "Turbine 1")
     - 1000
     - Gets the value from table cell (93360, "Turbine 1") which is 1000
   * - =TABLE.GET(A3:D5, 93360, "Turbine 2")
     - 2500
     - Gets the value from table cell (93360, "Turbine 1") which is 2500
